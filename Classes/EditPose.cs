...
namespace JTPoseCore
{
	public static class EditPose
	{
		...
		public static void SavePose( PoseClass posec=null, bool DoRefresh=true )
		{
			...
			string jsonString = System.Text.Json.JsonSerializer.Serialize<PoseClass>(posec, options);
		...
		public static void SendPoseToGame(bool doAuto = false)
		{
			...
			string jsonString = System.Text.Json.JsonSerializer.Serialize<PoseClass>(CurrentPose, options);
		...
		public static void SetCurrentData()
		{
			...
			CurrentPose = JsonConvert.DeserializeObject<PoseClass>(pdata);
